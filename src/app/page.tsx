		...
		<div className='flex flex-col gap-4 items-center place-content-center text-center  text-white'>
			...
			<div className='flex flex-col gap-10 items-center text-center w-2/4'>
				<p className='uppercase'>
					Create a D&D character in minutes with a digital character sheet, roll
					dice, and manage spells, inventory, hit points, and more. Join friends
					to conquer monsters, embark on epic quests, and craft imaginative,
					enjoyable stories.
				</p>
				<Link
					href='/sign/register'
					className='bg-white text-black uppercase border-4 w-2/6 border-black p-3 rounded-full text-sm'
				>
					Create an account
				</Link>
			</div>
